...
[![Discord](https://img.shields.io/badge/Discord-AtomixClub-5865F2?style=for-the-badge&logo=discord&logoColor=white)](https://discord.gg/atomixclub)
...
| Project | Description |
|---------|-------------|
| [**CracksTheCodes**](https://github.com/AtomixClub/CracksTheCodes) | Collection of decompiled Python code from various sources. Educational purposes only. |
...
- 🐦 **Twitter (soon)**: [@AtomixClub](https://twitter.com/AtomixClub) – I post about reverse engineering finds
- 💬 **Discord (soon)**: [AtomixClub Server](https://discord.gg/atomixclub) – Come talk decompilation
- 📧 **Email**: atomixclub@goatmail.uk – For serious inquiries only (no, I won't crack your ex's Instagram)
...
![Visitor Count](https://api.visitorbadge.io/api/combined?path=AtomixClub&label=Profile%20Views%20%5BDaily%20%2F%20Total%5D&labelColor=%23d9e3f0&countColor=%23555555&style=flat-square&labelStyle=upper)
